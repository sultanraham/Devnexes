    ...
    >
      ...
      >
        <div className="container mx-auto flex items-center justify-between text-xs font-semibold">
          ...
          {/* Left: Social Media Links & Tagline */}
          <div className="flex items-center gap-4 text-white/80">
            <a href="https://linkedin.com/company/devnexes-digital-solutions" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 hover:scale-110 transition-all" aria-label="LinkedIn">
            ...
            <a href="https://instagram.com/devnexes.digital.solutions" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 hover:scale-110 transition-all" aria-label="Instagram">
            ...
            <span className="text-blue-300 font-bold text-[11px] hidden sm:inline flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              Lahore, Pakistan — Digital Solutions &amp; AI Engineering
            </span>
          </div>
