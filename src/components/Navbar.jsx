    ...
    >
      ...
      >
        <div className="container mx-auto flex items-center justify-between text-xs font-semibold">
          ...
          {/* Left: Social Media Links (LinkedIn, Instagram, Facebook - Clean Text/Icon Hover) */}
          ...
          <div className="flex items-center gap-4 text-white/90 text-xs">
            <a href="mailto:devnexes.support@gmail.com" className="flex items-center gap-1.5 hover:text-white transition-colors">
              <Mail className="w-3.5 h-3.5 text-blue-300" />
              <span className="font-medium">devnexes.support@gmail.com</span>
            </a>

            <a href="tel:+923030111550" className="flex items-center gap-1.5 hover:text-white transition-colors">
